...
public class SyncOptionsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        syncOptionsViewModel =
                new ViewModelProvider(this).get(SyncOptionsViewModel.class);

        binding = FragmentSyncOptionsBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        final TextView textView = binding.textSyncOptions;
        syncOptionsViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
